...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        enc_hiddens, source_lengths = pad_packed_sequence(enc_hiddens)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # The weight of masked <pad> token is set to -inf in e_t
        # Afther softmax, it will become 0 in alpha_t
        # So it will not contribute to the attention output a_t
        # So why don't we use pack_padded_sequence() ?
        # Maybe because there is an attention projection
